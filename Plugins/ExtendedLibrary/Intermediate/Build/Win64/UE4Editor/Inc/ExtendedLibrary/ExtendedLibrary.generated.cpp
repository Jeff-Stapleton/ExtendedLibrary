...
FName EXTENDEDLIBRARY_ServerSetPostureState = FName(TEXT("ServerSetPostureState"));
	...
	IMPLEMENT_CLASS(UXLMovementComponent, 3551876805);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPostureState(EPostureState_StaticEnum, TEXT("/Script/ExtendedLibrary"), TEXT("EPostureState"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UXLAbilityManager, 2973078035);
	...
	IMPLEMENT_CLASS(AXLCharacter, 2914900980);
	...
	IMPLEMENT_CLASS(UXLCharacterResources, 3953385008);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EAbilityType(EAbilityType_StaticEnum, TEXT("/Script/ExtendedLibrary"), TEXT("EAbilityType"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(AXLGameMode, 1603217460);
...
static struct FScriptStruct_ExtendedLibrary_StaticRegisterNativesFDecalData
{
	...
	IMPLEMENT_CLASS(AXLImpactEffect, 1204529899);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EActionState()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::Climbing")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::Dodging")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::Jumping")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::None")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::Sprinting")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EActionState::EActionState_MAX")), 5));
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EActionState_CRC() { return 3580038976U; }
	UEnum* Z_Construct_UEnum_ExtendedLibrary_ECombatState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECombatState::Passive")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECombatState::Aggressive")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECombatState::ECombatState_MAX")), 2));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_ECombatState_CRC() { return 999334960U; }
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EHealthState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EHealthState::Alive")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EHealthState::Dying")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EHealthState::Dead")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EHealthState::EHealthState_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EHealthState_CRC() { return 1369241478U; }
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EMovementState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMovementState::AFK")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMovementState::Idle")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMovementState::Moving")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMovementState::EMovementState_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EMovementState_CRC() { return 319325245U; }
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EPostureState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPostureState::Crouching")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPostureState::Prone")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPostureState::Standing")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EPostureState::EPostureState_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EPostureState_CRC() { return 1891507351U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EAbilityType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EAbilityType::Activate")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EAbilityType::Channel")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EAbilityType::Toggle")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EAbilityType::EAbilityType_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EAbilityType_CRC() { return 2210965557U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_ExtendedLibrary_EWeaponState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EWeaponState::Idle")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EWeaponState::Firing")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EWeaponState::Reloading")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EWeaponState::Meleeing")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EWeaponState::EWeaponState_MAX")), 4));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_ExtendedLibrary_EWeaponState_CRC() { return 2092957423U; }
