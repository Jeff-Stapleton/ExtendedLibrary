...
class FXLPendingInvite
{
public:
	FXLPendingInvite() : ControllerId(-1), bPrivilegesCheckedAndAllowed(false) {}
...
public:
	...
	//UXLGameInstance(const FObjectInitializer& ObjectInitializer);

public:

	bool Tick(float DeltaSeconds);

	class AXLGameSession* GetGameSession() const;
...
private:
	...
	FXLPendingMessage PendingMessage;

	FXLPendingInvite PendingInvite;
