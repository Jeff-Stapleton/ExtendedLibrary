...
#include "XLGameSession.generated.h"

struct FXLGameSessionParams
{
...
UCLASS(config=game)
class AXLGameSession : public AGameSession
{
	GENERATED_UCLASS_BODY()

	//AXLGameSession(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	FXLGameSessionParams CurrentSessionParams;

	/** Current host settings */
	TSharedPtr<class FXLOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FXLOnlineSearchSettings> SearchSettings;
	...
	*/
	DECLARE_EVENT_TwoParams(AXLGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	*/
	...
	DECLARE_EVENT_OneParam(AXLGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	* Event triggered after session search completes
	*/
	//DECLARE_EVENT(AXLGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AXLGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
