...
#include "XLHasLineOfSightTo.h"

#include "BehaviorTree/BlackboardComponent.h"
#include "BehaviorTree/Blackboard/BlackboardKeyType_Object.h"
#include "BehaviorTree/Blackboard/BlackboardKeyType_Vector.h"

UXLHasLineOfSightTo::UXLHasLineOfSightTo()
{
	NodeName = "Has LoS To";
...
bool UXLHasLineOfSightTo::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
...
bool UXLHasLineOfSightTo::LOSTrace(AActor* InActor, AActor* InEnemyActor, const FVector& EndLocation) const
{
	static FName LosTag = FName(TEXT("AILosTrace"));
	AXLAIController* MyController = Cast<AXLAIController>(InActor);
	AXLAI* MyBot = MyController ? Cast<AXLAI>(MyController->GetPawn()) : NULL;
